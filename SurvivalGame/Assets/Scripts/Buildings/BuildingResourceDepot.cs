...
public class BuildingResourceDepot : BuildingProduction, IVisitable
{
  ...
  int metalWorkerCount = 0, woodWorkerCount = 0, huntingWorkerCount = 0;

  WorkSiteType currentSelectedSiteType;
  ...
  public override int[] GetCost()
  {
    ...
    {
      case 1: return GlobalConstants.resourceDepotCost;
      case 2: return GlobalConstants.resourceDepot2Cost;
      case 3: return GlobalConstants.resourceDepot3Cost;
      case 4: return GlobalConstants.resourceDepot4Cost;
      default: return null;
    }
  }
  ...
  public void SetCurrentWorkSiteType(WorkSiteType workSiteToFind)
  {
    ...
    {
      var tempWorkSite = area.gameObject.GetComponent<WorkSite>();
      ...
      if (tempWorkSite.SiteType == workSiteToFind)
      {
        ...
        if (workSite)
        {
          var tempDistance = Vector3.Distance(transform.position, workSite.gameObject.transform.position);
        ...
        else workSite = tempWorkSite.gameObject;
  ...
  void ManageWorkerCount(WorkSiteType site, int x)
  {
    switch (site)
    {
      case WorkSiteType.Forest:
